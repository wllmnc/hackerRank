...
if m==0:
    ...
    print "quarter " + ("past " if m<30 else "to ") + (numbers[h]  if m<30 else numbers[(h+1)%12])
else:
    print numbers[(m if m<30 else (60-m))] + " minute" + ("s" if (m if m<30 else (60-m))>1 else "" ) + (" past " if m<30 else " to ") + (numbers[h]  if m<30 else numbers[(h+1)%12])
